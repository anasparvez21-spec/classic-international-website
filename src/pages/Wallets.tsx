...
const Wallets: React.FC = () => {
  ...
  const products = getProductsByCategory('wallets');
  ...
  <div className="min-h-screen bg-gray-50 py-10 px-4 relative">
      ...
      <h1 className="text-3xl font-bold mb-8 text-center">Premium Leather Wallets</h1>
      <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
        Discover our collection of handcrafted leather wallets, made from the finest materials with attention to every detail.
      </p>
      ...
      {hoverImg && (
        ...
        >
          <div className="bg-white rounded-lg shadow-2xl border-4 border-gray-200 p-2 transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] scale-95 opacity-0 animate-enlarge-fade-in">
            <img src={hoverImg} alt="Preview Wallet" className="max-h-[60vh] max-w-[80vw] rounded-lg transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)]" />
          </div>
        </div>
      )}
    </div>
